...
Project("{9A19103F-16F7-4668-BE54-9A1E7A4F7556}") = "SampleServer", "SampleServer\SampleServer.csproj", "{788826E5-FDE7-4FEE-9E01-440329772002}"
EndProject
Global
	...
	GlobalSection(ProjectConfigurationPlatforms) = postSolution
		{788826E5-FDE7-4FEE-9E01-440329772002}.Debug|Any CPU.ActiveCfg = Debug|Any CPU
		{788826E5-FDE7-4FEE-9E01-440329772002}.Debug|Any CPU.Build.0 = Debug|Any CPU
		{788826E5-FDE7-4FEE-9E01-440329772002}.Release|Any CPU.ActiveCfg = Release|Any CPU
		{788826E5-FDE7-4FEE-9E01-440329772002}.Release|Any CPU.Build.0 = Release|Any CPU
	EndGlobalSection
	GlobalSection(SolutionProperties) = preSolution
		HideSolutionNode = FALSE
	EndGlobalSection
	GlobalSection(ExtensibilityGlobals) = postSolution
		SolutionGuid = {598B45DF-1D8E-496D-8FFB-BE6113FE568C}
	EndGlobalSection
EndGlobal
...
================================================
File: SampleServer/SampleServer.csproj
================================================
...
================================================
File: SampleServer/apiTest.http
================================================
@host = http://localhost:8080

### ============================================
### 1. 기본 로깅 - LogLevel별 출력
### ============================================
...
### Scope Demo - RequestId와 Step이 중첩된 scope로 기록됨
POST {{host}}/logging/scope
Content-Type: application/json

{
  "message": "Testing nested scopes"
}
...
### Exception Demo - 스택 트레이스가 포함된 에러 로그
POST {{host}}/logging/exception
Content-Type: application/json

{
  "message": "Trigger exception for demo"
}

### ============================================
### 4. 로그인 시나리오 (BaseController 패턴)
### ============================================

### 로그인 성공 - ActionLog + InformationLog 출력
POST {{host}}/login
Content-Type: application/json
...
### ============================================
### 5. 게임 시작 시나리오 (BeginScope + MetricLog)
### ============================================

### 게임 시작 성공 - BeginScope(uid) + MetricLog("GameCreated") + ActionLog
...
### 게임 시작 실패 (잘못된 uid) - Warning + ErrorLog
POST {{host}}/game/start
Content-Type: application/json
...
================================================
File: SampleServer/appsettings.Development.json
================================================
{
  "Logging": {
    "LogLevel": {
...
================================================
File: SampleServer/appsettings.json
================================================
{
  "Logging": {
    "LogLevel": {
...
================================================
File: SampleServer/Controllers/BaseController.cs
================================================
...
================================================
File: SampleServer/Controllers/GameController.cs
================================================
using Microsoft.AspNetCore.Mvc;
...
================================================
File: SampleServer/Controllers/LoggingController.cs
================================================
using Microsoft.AspNetCore.Mvc;
using SampleServer.DTO;
using ZLogger;
...
================================================
File: SampleServer/Controllers/LoginController.cs
================================================
using Microsoft.AspNetCore.Mvc;
using SampleServer.DTO;
using SampleServer.Models;
...
================================================
File: SampleServer/DTO/GameDTO.cs
================================================
...
================================================
File: SampleServer/DTO/LogRequest.cs
================================================
using System.ComponentModel.DataAnnotations;
...
================================================
File: SampleServer/Models/ErrorCode.cs
================================================
...
================================================
File: SampleServer/Properties/launchSettings.json
================================================
﻿{
  ...
  "iisSettings": {
    ...
    "iisExpress": {
      "applicationUrl": "http://localhost:23961",
      "sslPort": 0
    }
  },
  "profiles": {
...
================================================
File: SampleServer/Services/BaseLogger.cs
================================================
using System.Runtime.CompilerServices;
using ZLogger;
...
================================================
File: SampleServer/Services/GameService.cs
================================================
using SampleServer.Models;
using ZLogger;
...
================================================
File: SampleServer/Services/IGameService.cs
================================================
using SampleServer.Models;
