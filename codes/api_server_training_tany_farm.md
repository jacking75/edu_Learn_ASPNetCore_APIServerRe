...
└── api_server_training_tany_farm/
    ...
    │   ├── appsettings.json
    │   ├── Controllers/
    │   │   ├── AuthCheckController.cs
    │   │   └── InAppCheckController.cs
    │   └── Properties/
    │       └── launchSettings.json
    └── images/
...
> **과제 명세 전용.** 이 디렉토리에는 FakeHiveServer만 포함되어 있으며, 게임 서버 코드는 학습자가 직접 구현해야 한다.
...
================================================
File: FakeHiveServer/APIServer.csproj
================================================
...
================================================
File: FakeHiveServer/APIServer.sln
================================================
﻿
Microsoft Visual Studio Solution File, Format Version 12.00
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "APIServer", "APIServer.csproj", "{C4BF4730-21F7-4F00-A236-706420265F0D}"
EndProject
Global
...
================================================
File: FakeHiveServer/ErrorCode.cs
================================================
癤퓎sing System;
...
================================================
File: FakeHiveServer/Program.cs
================================================
using System;
using System.IO;
...
================================================
File: FakeHiveServer/apiTest.http
================================================
癤풮OST http://localhost:11502/AuthCheck
...
================================================
File: FakeHiveServer/appsettings.Development.json
================================================
{
  "Logging": {
    "LogLevel": {
...
================================================
File: FakeHiveServer/appsettings.json
================================================
{
  "Logging": {
    "LogLevel": {
...
================================================
File: FakeHiveServer/Controllers/AuthCheckController.cs
================================================
...
================================================
File: FakeHiveServer/Controllers/InAppCheckController.cs
================================================
...
================================================
File: FakeHiveServer/Properties/launchSettings.json
================================================
﻿{
